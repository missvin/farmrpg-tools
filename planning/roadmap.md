...
- Item-level goal and source planning
  ...
  - cache-first Buddy item-page evidence workflow (`BL-243`, shipped), initial reviewed cache population (`BL-247`, shipped), and freshness/recheck controls (`BL-244`, planned)
  - multi-source Buddy item-page parser and reviewed promotion fan-out (`BL-245`, `BL-246`, planned)
