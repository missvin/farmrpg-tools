...
- Item-level goal and source planning
  ...
  - cache-first Buddy item-page evidence workflow (`BL-243`, shipped), initial reviewed cache population (`BL-247`, planned), and freshness/recheck controls (`BL-244`, planned)
